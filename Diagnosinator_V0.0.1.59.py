...
class MainWindow(qtw.QMainWindow):
    ...
    def __init__(self):
        ...
        self.variable_heme_table_increment = 0
    ...
    def hematology(self):
        ...
        self.table_heme_values.setRowCount(1)
        ...
        for test, unit in hematology_tests.items():
            ...
            # print(var_heme_table_row)
            # var_heme_table_row = int(self.table_heme_values.rowCount())
            # print(var_heme_table_row)
            label_test = 'self.label_heme_'+test
            label_test = qtw.QLabel()
            self.table_heme_values.setItem(
                row_number, 0, qtw.QTableWidgetItem(test))
