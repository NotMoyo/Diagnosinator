 ...
 #########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  #####
   #####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      #####
    ...
    def search_symptom(self):
        ...
        if self.lineedit_symptom_search.text() == '':
            ...
            try:
                ...
                if self.new_dict_widgets[selected_ID_lineedit] != '': self.pushbutton_add_symptom.show()
                else: pass
    ...
    def load_dblclicked_pt(self):
        ...
        c.execute("SELECT * FROM Patient_Symptoms WHERE (ID = "+str(clicked_patient_id)+")")
        ...
        c.execute("SELECT * FROM Hematology_Values WHERE (ID = "+str(clicked_patient_id)+")")
        ...
        try:
            if self.list_symptom_search.isVisible() == True:    self.pushbutton_add_symptom.show()
            else:   pass
        except:
            print('except1')
        #---END---#
