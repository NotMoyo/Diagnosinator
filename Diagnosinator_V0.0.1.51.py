...
class MainWindow(qtw.QMainWindow):
    ...
    def diagnosis_tab(self): # Diagnosis Tab
        ...
        self.pushbutton_delete_database.setStyleSheet("""
                min-width:""" + str(button_width) + """;
                max-width:""" + str(button_width) + """;
                min-height:""" + str(button_height) + """;
                max-height:""" + str(button_height) + """;
                border: 3px solid #cc1714;
                border-radius:3px;
 ...
 #########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  #####
   #####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      #####
    ...
    def remove_selected_symptom(self):
        print('kittens')
        variable_selected_current_pt_symptom = self.list_patient_symptoms.currentItem()
        self.list_patient_symptoms.removeItemWidget(variable_selected_current_pt_symptom)
        print(variable_selected_current_pt_symptom)
