...
class MainWindow(qtw.QMainWindow):
    ...
    def hematology(self):
        ...
        # self.table_heme_values.setRowCount(5)
        start_y = 75
        # Heme Validators.
        ...
        for test, unit in hematology_tests.items():
            ...
            table_test_name = qtw.QTableWidgetItem()
            table_test_name.setText(test)
            self.table_heme_values.setItem(
                self.table_heme_values.rowCount(), 1, table_test_name)
            self.dict_heme_table_test_row_widgets[test] = table_test_name
            self.table_heme_values.setRowCount(
                self.table_heme_values.rowCount()+1)

            print(self.table_heme_values.sizeHint())
        ...
        self.table_heme_values.setFixedHeight(self.hematology_tab.height()+100)

        self.dict_heme_widgets = {}
