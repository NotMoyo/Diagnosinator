...
class MainWindow(qtw.QMainWindow):
    ...
    def diagnosis_tab(self): # Diagnosis Tab
        ...
        self.groupbox_high_probability.setParent(self.tab_diagnosis)
        self.groupbox_medium_probability.setParent(self.tab_diagnosis)
        self.groupbox_low_probability.setParent(self.tab_diagnosis)
        self.groupbox_patient_symptoms.setParent(self.tab_diagnosis)
