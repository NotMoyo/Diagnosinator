...
class MainWindow(qtw.QMainWindow):
    ...
    def hematology_tab(self):
        ...
        self.table_heme_values.setStyleSheet(
            'border: 2px solid gray;background-color:cyan;')
        # Increment Variable.
        start_y = 75
        # Heme Validators.
        ...
        for test, unit in self.list_hematology_tests.items():
            ...
            the_test_widget.setFlags(qtc.Qt.ItemIsEnabled)
 ...
 #########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  #####
   #####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      #####
    ...
    def update_id_track(self):
        ...
        self.dict_all_widgets['save_ID_lineedit'].setText(str(self.id_track))
    ...
    def save_patient_info(self):
        ...
        var_save_patient_info = Class_Patient_Information(
            ...
            First_Name=self.dict_all_widgets['save_First_Name_lineedit'].text(
            ),
            Middle_Name=self.dict_all_widgets['save_Middle_Name_lineedit'].text(
            ),
            Last_Name=self.dict_all_widgets['save_Last_Name_lineedit'].text(),
            Gender=self.dict_all_widgets['save_Gender_combobox'].currentText(),
            DOB=self.dict_all_widgets['save_Date_of_Birth_lineedit'].text())
        ...
        #     ID=self.dict_all_widgets['save_ID_lineedit'].text(),
        #     PLT=self.dict_all_widgets['heme_PLT_lineedit'].text(),
        #     WBC=self.dict_all_widgets['heme_WBC_lineedit'].text(),
        #     RBC=self.dict_all_widgets['heme_RBC_lineedit'].text(),
        #     HGB=self.dict_all_widgets['heme_HGB_lineedit'].text(),
        #     HCT=self.dict_all_widgets['heme_HCT_lineedit'].text(),
        #     MCV=self.dict_all_widgets['heme_MCV_lineedit'].text(),
        #     MCH=self.dict_all_widgets['heme_MCH_lineedit'].text(),
        #     MCHC=self.dict_all_widgets['heme_MCHC_lineedit'].text(),
        #     RDW=self.dict_all_widgets['heme_RDW_lineedit'].text(),
        #     MPV=self.dict_all_widgets['heme_MPV_lineedit'].text(),
        #     PER_NEUT=self.dict_all_widgets['heme_PER_NEUT_lineedit'].text(),
        #     PER_LYMPH=self.dict_all_widgets['heme_PER_LYMPH_lineedit'].text(),
        #     PER_MONO=self.dict_all_widgets['heme_PER_MONO_lineedit'].text(),
        #     PER_EOS=self.dict_all_widgets['heme_PER_EOS_lineedit'].text(),
        #     PER_BASO=self.dict_all_widgets['heme_PER_BASO_lineedit'].text(),
        #     PER_IG=self.dict_all_widgets['heme_PER_IG_lineedit'].text(),
        #     ABS_NEUT=self.dict_all_widgets['heme_ABS_NEUT_lineedit'].text(),
        #     ABS_LYMPH=self.dict_all_widgets['heme_ABS_LYMPH_lineedit'].text(),
        #     ABS_MONO=self.dict_all_widgets['heme_ABS_MONO_lineedit'].text(),
        #     ABS_EOS=self.dict_all_widgets['heme_ABS_EOS_lineedit'].text(),
        #     ABS_BASO=self.dict_all_widgets['heme_ABS_BASO_lineedit'].text(),
        #     ABS_IG=self.dict_all_widgets['heme_ABS_IG_lineedit'].text())
    ...
    def clear_hematology_info(self):
        test_print = self.table_heme_values.item(1, 1).text()
        print(test_print)
        # for name, widget in self.dict_all_widgets.items():
