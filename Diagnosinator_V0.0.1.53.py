...
class MainWindow(qtw.QMainWindow):
    ...
    def diagnosis_tab(self): # Diagnosis Tab
        ...
        self.list_patient_symptoms.setStyleSheet(self.list_symptom_search.styleSheet())
        self.label_high_probability.setStyleSheet('font: 15px; font: bold')
        self.label_medium_probability.setStyleSheet(self.label_high_probability.styleSheet())
        self.label_low_probability.setStyleSheet(self.label_high_probability.styleSheet())
        self.label_patient_symptoms.setStyleSheet(self.label_high_probability.styleSheet())
        # Set Fixed Size.
        ...
        self.list_medium_probability.setFixedSize(self.list_high_probability.width(),self.list_high_probability.height())
        self.list_low_probability.setFixedSize(self.list_high_probability.width(),self.list_high_probability.height())
        self.lineedit_symptom_search.setFixedSize(200,25)
        self.list_symptom_search.setFixedSize(475,275)
        self.list_patient_symptoms.setFixedSize(self.list_high_probability.width(),self.list_symptom_search.height()+20)
        ...
        self.pushbutton_edit_patient.move(self.pushbutton_add_patient.x()+button_width+20,(self.pushbutton_add_patient.y()))
        ...
        self.list_high_probability.move(500,((self.groupbox_list_patients.frameGeometry().bottom())-self.list_high_probability.height()))
        self.list_medium_probability.move((self.list_high_probability.x()+self.list_high_probability.width()+25),self.list_high_probability.y())
        self.list_low_probability.move((self.list_medium_probability.x()+self.list_medium_probability.width()+25),self.list_high_probability.y())
        ...
        self.list_patient_symptoms.move(self.list_high_probability.x(),self.list_symptom_search.y()-20)
        self.pushbutton_symptom_search.move((self.lineedit_symptom_search.frameGeometry().right()+20),self.lineedit_symptom_search.y())
        self.pushbutton_add_symptom.move((self.list_symptom_search.x()+5),self.list_symptom_search.frameGeometry().bottom()+10)
        self.pushbutton_remove_symptom.move((self.list_patient_symptoms.x()+5),self.list_patient_symptoms.frameGeometry().bottom()+10)
        self.label_high_probability.move(((self.list_high_probability.frameGeometry().center().x())-(int((self.label_high_probability.width())/2))),((self.list_high_probability.y())-self.label_high_probability.height())-5)
        self.label_medium_probability.move(((self.list_medium_probability.frameGeometry().center().x())-(int((self.label_medium_probability.width())/2))),self.label_high_probability.y())
        self.label_low_probability.move(((self.list_low_probability.frameGeometry().center().x())-(int((self.label_low_probability.width())/2))),self.label_high_probability.y())
        self.label_patient_symptoms.move(((self.list_patient_symptoms.frameGeometry().center().x())-(int((self.label_patient_symptoms.width())/2))),((self.list_patient_symptoms.y())-self.label_patient_symptoms.height())-5)
        # Set Parent.
        ...
        self.pushbutton_remove_symptom.clicked.connect(self.remove_selected_symptom)
    ...
    ##################################################
    ##################################################
    def window_add_patient(self):  # New Window to Add a Patient to the Database.
        #---BEGINNING---#
        # Creating Widgets.
    ...
    def statusbar(self):
        ...
        # Set Style Sheet.
        self.statusbar.setStyleSheet('border: 2px solid gray;background-color:lightgray;')
        self.labelstatusbar_datetime.setStyleSheet('background-color:lightgray')
        # Font.
    ...
    def hematology(self):
        ...
        self.pushbutton_clear_hematology.move((self.pushbutton_save_hematology.x()+self.pushbutton_save_hematology.width()+50),self.pushbutton_save_hematology.y())
        # Set Parent.
        ...
        self.pushbutton_clear_hematology.clicked.connect(self.clear_hematology_info)
        # Initializing.
        start_y = 75
        # Heme Validators.
    ...
    def exit_button(self): # Exit Button.
        ...
        self.pushbutton_exit.move((self.width()-self.pushbutton_exit.width()-50), (self.statusbar.y()-self.pushbutton_exit.height()-35))
        
        self.pushbutton_exit.setParent(self.tab_diagnosis)
        
        self.pushbutton_exit.setStyleSheet('background-color: #D81A16; font: 13px; font: bold; spacing: 10; border: 2px solid #F5F5F5;')
 ...
 #########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  ########  #####
   #####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      ####      #####
    ...
    def add_selected_symptom(self):
        ...
        self.list_patient_symptoms.addItem(self.list_symptom_search.currentItem().text())
    ...
    def remove_selected_symptom(self):
        ...
        try:
            sel_sym_code, sel_sym_name = (self.list_patient_symptoms.currentItem().text()).split(' | ')

            conn = sql.connect('patients.db')
            c = conn.cursor()
            c.execute("DELETE FROM [Patient_Symptoms] WHERE SYM_CODE = (?)", (str(sel_sym_code),))
            conn.commit()
            conn.close()
    ...
    def save_patient_symptoms(self):
        ...
        sel_sym_code, sel_sym_name = (self.list_symptom_search.currentItem().text()).split(' | ')
    ...
    def remove_patient_info(self):
        ...
        if current_row == 0:
            ...
            c.execute("DELETE FROM Patient_List WHERE ID = (?)", (int(self.clicked_patient_id),))
    ...
    def load_pt_info(self):
        ...
        c.execute("SELECT * FROM Patient_List WHERE (ID = "+str(self.clicked_patient_id)+")")
    ...
    def load_pt_symptoms(self):
        ...
        c.execute("SELECT * FROM Patient_Symptoms WHERE (ID = "+str(self.clicked_patient_id)+")")
        ...
        for symptoms in range(len(self.selected_patient)):
            dict_selected_patient_symptoms[self.selected_patient[symptoms][1]] = self.selected_patient[symptoms][2]
    ...
    def load_pt_heme(self):
        ...
        c.execute("SELECT * FROM Hematology_Values WHERE (ID = "+str(self.clicked_patient_id)+")")
        ...
        for info in range(len(self.selected_patient[0])):
            list_selected_patient_heme_values.append(self.selected_patient[0][info])
        
        for column in range(len(list_database_columns)):
            dict_selected_patient_heme_values[list_database_columns[column]] = list_selected_patient_heme_values[column]
    ...
    ##################################################
    ##################################################
    def delete_database(self,button): #---BEGINNING---#
        #---BEGINNING---#
